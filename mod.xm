...
%ctor {
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(3.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        // چارەسەرکردنی ئاگاداری keyWindow بە بەکارهێانی سەردەمی نوێی UIApplication
        ...
        // بۆکسێکی سەرنجڕاکێش بە دیزاینی ڕەش و لێواری سپی
        ...
        // خانەی نووسینی کۆد (چارەسەرکردنی هەڵەی borderColor بە زیادکردنی CGColor)
        ...
        textField.layer.borderColor = [UIColor colorWithWhite:0.3 alpha:1.0].CGColor; // لێرە CGColor زیاد کرا
